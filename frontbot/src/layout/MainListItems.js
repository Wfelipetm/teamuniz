        ...
        yes={() => (
          <>
            ...
            <>
              ...
              >
                <List component="div" disablePadding>
                  <ListItem onClick={() => history.push("/flow-builder")} button>
                    <ListItemIcon><AccountTreeOutlinedIcon /></ListItemIcon>
                    <ListItemText primary={i18n.t("mainDrawer.listItems.flows")} />
                  </ListItem>
                  <ListItem onClick={() => history.push("/flow-campaigns")} button>
                    <ListItemIcon><ListIcon /></ListItemIcon>
                    <ListItemText primary={i18n.t("mainDrawer.listItems.flowCampaigns")} />
                  </ListItem>
                </List>
              </Collapse>
            </>
