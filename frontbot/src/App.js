...
const App = () => {
    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#1E3A8A" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#1E3A8A" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#1E3A8A" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #1E3A8A, #2563EB , #1E3A8A)" : "#666",
    ...
    useEffect(() => {
        ...
        const handleLangChange = (lang) => {
            setLocale(getLocale(lang?.substring(0, 2)));
            setLangKey(k => k + 1);
        };
